...
async function getComments(req, res, headers){
    // http://localhost:5000/comments?recipe_id=60ad6b4b11055631b080bdde
...
async function addComment(req, res, headers) {
   // http://localhost:5000/comments?recipe_id=60ad6b4b11055631b080bdde&user_id=6099a85c85afd46d920f4fbd
...
async function deleteComment(req, res, headers) {
    ...
    if (user_id === undefined || recipe_id === undefined || comment_id === undefined) {
        res.writeHead(404, headers);
        ...
        if (comment_by_id.user_id === user_id._id) {
            // sterg comentariul din array-ul de comentarii din reteta
            ...
            if (idx) {
                ...
                // res.writeHead(200, headers);
                // res.write(JSON.stringify({"message": "Comentariu sters din reteta"}, null, 4))
                // res.end();
            }
            ...
            // comentariul nu este adaugat de acest user
        }
